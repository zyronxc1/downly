...
class ConversionService {
     ...
     */
    convertMedia(url, targetFormat, timeout = this.defaultTimeout) {
        ...
        const ytDlpProcess = (0, child_process_1.spawn)(this.ytDlpPath, ytDlpArgs, {
        ...
        const ffmpegProcess = (0, child_process_1.spawn)(this.ffmpegPath, ffmpegArgs, {
     ...
     */
    async getConvertedFilename(url, targetFormat) {
        try {
